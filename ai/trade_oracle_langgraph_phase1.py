...
def phase2_scanner_setup_to_raw_setup(
    ...
    *,
    ...
    return ScannerRawSetup(
        ...
        candidate_portfolio=scanner_setup.get("candidate_portfolio", []),
        portfolio_expectancy=float(scanner_setup.get("portfolio_expectancy", 0.0)),
        portfolio_max_dd_pct=float(scanner_setup.get("portfolio_max_dd_pct", 0.0)),
        portfolio_consistency_score=float(scanner_setup.get("portfolio_consistency_score", 0.0)),
        portfolio_overall_survival=bool(scanner_setup.get("portfolio_overall_survival", False)),
        scanner_metadata=scanner_metadata,
        tokenomics_watch=setup.tokenomics_watch,
